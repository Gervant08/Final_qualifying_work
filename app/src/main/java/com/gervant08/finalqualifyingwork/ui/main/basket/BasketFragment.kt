...
class BasketFragment : Fragment(R.layout.fragment_basket) {
    ...
    private val basketAdapter = BasketAdapter{basketItem -> basketViewModel. }
    ...
    private fun onDishesInBasketChange(dishesList: ArrayList<MenuItem>) {
        basketAdapter.updateDishesList(basketViewModel.convertMenuItemsToBasketItems(dishesList))
    }
